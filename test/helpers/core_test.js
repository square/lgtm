...
describe('helpers.core', () => {
  ...
  it('checkEmail', () => {
    ...
    ok(
      !checkEmail()('anything@paypal'),
      'returns false for missing . in domain part'
    );
    ok(!checkEmail()('!$23@screwedup'), 'returns false for invalid characters');
    ok(!checkEmail()(''), 'returns false for empty string');
    ok(
      checkEmail()('mañana@squareup.com'),
      'returns true for emails with characters in extended ASCII range'
    );
    ok(
  ...
  it('checkMinLength', () => {
    ok(
      checkMinLength(5)('12345'),
      'returns true for 5-characters long strength calling with 5'
    );
    ok(
      !checkMinLength(6)('12345'),
      'returns false for 5-characters long strength calling with 6'
    );
  ...
  it('checkMaxLength', () => {
    ok(
      checkMaxLength(5)('12345'),
      'returns true for 5-characters long strength calling with 5'
    );
    ok(checkMaxLength(5)(''), 'returns true for empty string');
    ok(
      !checkMaxLength(4)('12345'),
      'returns false for 5-characters long strength calling with 4'
    );
